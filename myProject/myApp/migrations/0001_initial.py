# Generated by Django 5.0.6 on 2024-06-02 03:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('recruiter', 'Recruiter'), ('job_seeker', 'JOb_Seeker')], max_length=100, null=True)),
                ('city', models.CharField(max_length=100, null=True)),
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('other', 'Other')], max_length=100, null=True)),
                ('profile_picture', models.ImageField(null=True, upload_to='static/picture/user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_logo', models.ImageField(null=True, upload_to='static/picture/company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('myuser', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='SeekerProfileModel', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
